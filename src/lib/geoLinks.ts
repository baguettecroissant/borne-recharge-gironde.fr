/**
 * Geographic proximity linking engine for Gironde (33).
...
export function getNearbyCommunes(
  ...
  return allCommunes
    ...
    .map(c => {
      ...
      // Approximate physical distance in km using local projection (44.83°N for Gironde)
      // 1 degree of Latitude ≈ 111.1 km
      // 1 degree of Longitude ≈ 111.1 * cos(44.83°) ≈ 78.8 km
      const dLat = (lat - currentLat) * 111.1;
      const dLon = (lon - currentLon) * 78.8;
